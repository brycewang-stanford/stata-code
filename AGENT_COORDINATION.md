...
| Core runner / schema changes | Claude | 2026-06-23 pass complete: error-taxonomy correctness. Audited `RC_TO_KIND` against StataCorp `[P] error` (Stata 19) and fixed misclassified codes (5/119/122/123/322/459/480/604/615/616/691–693/1400); added `RC_LABEL` + `label_for_rc()` so `error.rc_label` is populated for real Stata errors; expanded `suggestions_for()` to NETWORK/INFEASIBLE/TYPE_MISMATCH/FILE_IO/FILE_CORRUPT/PERMISSION/ESTIMATION_FAILURE/MATRIX_MISSING; SCHEMA.md kind table synced; +26 tests, full suite 485 green, ruff clean | `stata_code/core/**`, `SCHEMA.md`, `schema/**` |
